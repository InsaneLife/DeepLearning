...
if __name__ == '__main__':
    ...
    test_vector_folder = 'E:/soft/Project/zte/ztedata/youtube/test_set_file_vector/'
    train_vector_folder = 'E:/soft/Project/zte/ztedata/youtube/train_set_file_vector/'
