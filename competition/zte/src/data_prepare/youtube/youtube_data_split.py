...
if __name__ == '__main__':
    src_folder = 'E:/soft/Project/zte/ztedata/youtube/youtube_copy/'
    test_set_file = 'E:/soft/Project/zte/ztedata/youtube/test_set_file.csv'
    train_set_file = 'E:/soft/Project/zte/ztedata/youtube/train_set_file.csv'
