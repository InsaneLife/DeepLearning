...
def walk_through_the_folder_for_crop(aligned_db_folder, result_folder):
    ...
    for people_folder in os.listdir(aligned_db_folder):
        ...
        i += 1
        img_count += len(os.listdir(dest_people_path))
...
if __name__ == '__main__':
    ...
    # it already face images, just change size
    walk_through_the_folder_for_crop('E:/soft/Project/zte/ztedata/ImgDataset/actors/faces/',
                                       result_folder)
    # actresses
    walk_through_the_folder_for_crop('E:/soft/Project/zte/ztedata/ImgDataset/actresses/faces/',
                                       result_folder)
