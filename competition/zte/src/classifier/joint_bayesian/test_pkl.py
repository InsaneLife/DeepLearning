...
def excute_train(train_data='E:/soft/Project/zte/ztedata/youtube/train_set_file_vector/', result_fold="../result/"):
...
def excute_zte_test(pairlist="E:/soft/Project/zte/ztedata/zte_face_test/test1/rgb_set_file_vector/0.pkl",
