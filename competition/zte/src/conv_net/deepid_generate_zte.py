...
if __name__ == '__main__':
    ...
    params_file = 'E:/soft/Project/zte/ztedata/zte_face_test/test1/params_file_youtube'
    dataset_folder = 'E:/soft/Project/zte/ztedata/zte_face_test/test1/rgb_set_file_vector/'

    result_folder = 'E:/soft/Project/zte/ztedata/zte_face_test/test1/rgb_result_folder/'
    nkerns  = [20,40,60,80]
    n_hidden = 160
