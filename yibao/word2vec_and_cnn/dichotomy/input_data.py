...
from Deep_learning.yibao.word2vec_and_cnn.dichotomy import word_match_vector
...
def read_data_sets(file_path='../../../data/yibao/word2vec/word2vec_and_cnn/ykc100_cut_vector_top10.txt', fake_data=False, one_hot=False):
    ...
    train_images, train_labels, test_images, test_labels = word_match_vector.get_data()
