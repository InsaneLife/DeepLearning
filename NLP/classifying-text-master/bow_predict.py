...
train_file = '../../../data/NLP/text_classifer/labeledTrainData.tsv'
test_file = '../../../data/NLP/text_classifer/testData.tsv'
output_file = '../../../data/NLP/text_classifer/bow_predictions.csv'
